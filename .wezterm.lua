...
config.keys = {
  ...
  {key="C", mods="LEADER|SHIFT", action=wezterm.action.PromptInputLine{
  ...
  -- Workspace: switch
  {key="W", mods="LEADER|SHIFT", action=wezterm.action.ShowLauncherArgs{
      flags="WORKSPACES"
    }},
  ...
  {key="H", mods="SHIFT|LEADER", action=wezterm.action.AdjustPaneSize({"Left", 5})},
  {key="J", mods="SHIFT|LEADER", action=wezterm.action.AdjustPaneSize({"Down", 5})},
  {key="K", mods="SHIFT|LEADER", action=wezterm.action.AdjustPaneSize({"Up", 5})},
  {key="L", mods="SHIFT|LEADER", action=wezterm.action.AdjustPaneSize({"Right", 5})},
